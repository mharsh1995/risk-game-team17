...
public class RiskMapVerify implements Serializable {
     ...
     *
     * @return HashMap which contains adjacent countries corresponding each country.
     */
     ...
     *
     * @return HashMap which contains countries in a continent.
     */
     ...
     *
     * @return mapTagData ArrayList Contents of map details
     */
